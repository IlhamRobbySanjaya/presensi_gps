            ...
            <div class="card-body p-lg-5 p-0">
                <div class="p-4">
                    <div class="text-center mb-4">
                        <h1 class="h4 text-gray-900">Aplikasi Presensi Online</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input value="<?= set_value('jabatan'); ?>" type="text" name="jabatan" class="form-control form-control-user" placeholder="Jabatan">
