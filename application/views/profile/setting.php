                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nip', $user['nip']); ?>" name="nip" id="nip" type="text" class="form-control" placeholder="nip...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('jabatan', $user['jabatan']); ?>" name="jabatan" id="jabatan" type="text" class="form-control" placeholder="jabatan Anda...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('alamat', $user['alamat']); ?>" name="alamat" id="alamat" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
